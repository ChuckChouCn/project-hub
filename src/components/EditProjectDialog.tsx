...
interface EditProjectDialogProps {
  project: Project;
  onUpdate: (id: string, p: UpdateProject) => Promise<unknown>;
  onClose: () => void;
}

export function EditProjectDialog({ project, onUpdate, onClose }: EditProjectDialogProps) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100 mb-5">编辑项目</h2>
